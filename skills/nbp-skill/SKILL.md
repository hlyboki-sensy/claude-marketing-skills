...
Для складних сцен із багатьма деталями — використовуй JSON:
...
Коли використовувати: fashion shots, product scenes, деталізовані інтер'єри, складна композиція з 5+ елементами.
